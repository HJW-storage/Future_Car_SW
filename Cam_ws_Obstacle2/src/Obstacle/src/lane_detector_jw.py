...
class LaneDetector:
    ...
    def __init__(self):
        ...
        self.leftx_current, self.rightx_current = [130], [self.rightx_mid]
    ...
    def sliding_window(self, img, nwindows=8, margin=40, minpix=35, draw_windows=False):
        # 크기 3의 비어있는 배열 생성
    ...
    def process(self, origin_img):
        ...
        combined_img=cv2.line(combined_img,(70, 440), (170, 330),(0,255,0),5)
        combined_img=cv2.line(combined_img,(530, 330), (630, 440),(0,255,0),5)

...
class RP:
    def __init__(self):
        ...
        calib_file = '/home/park/cam_ws/src/camera_2d_lidar_calibration/data/calibration_result.txt'
        config_file = '/home/park/cam_ws/src/camera_2d_lidar_calibration/config/config.yaml'

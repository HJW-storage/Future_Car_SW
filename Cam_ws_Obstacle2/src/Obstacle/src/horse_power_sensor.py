...
class HPSensor:
    ...
    def __init__(self):
        ...
        # # camera
        # self.traffic_cam = None
        # rospy.Subscriber("/camera1/usb_cam2/image_raw", Image, self.callback_traffic_cam)
    ...
    # def callback_traffic_cam(self, msg):
    #     self.traffic_cam = self.bridge.imgmsg_to_cv2(msg, "bgr8")

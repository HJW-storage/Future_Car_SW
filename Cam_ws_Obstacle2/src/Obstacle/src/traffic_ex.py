...
class traffic:
    def __init__(self):
        ...
        # self.bottom_right_up = (640, 50)

        self.upper_left_down = (0, 340)
        self.bottom_right_down = (640, 480)

        #self.upper_left_left = (0, 50)
        #self.bottom_right_left = (20, 340)

        #self.upper_left_right = (540, 50)
        #self.bottom_right_right = (640, 340)

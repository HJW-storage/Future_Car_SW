...
class LaneDetector:
    ...
    def get_position(self, leftx_fit,right_fitx, path_x, path_y, img,lane_idx):
        ...
        if len(path_mid) > 0 and len(path_y) > 0:
            ...
            if lane_direction > 0:
                ...
                if lane_direction >= 5:
                    lane_direction *= 0.35
                elif 5 < lane_direction <= 10:
                    lane_direction *= 0.45
                elif 10 <lane_direction <= 20:
                    lane_direction *= 0.55
                elif lane_direction >= 20.0:
                    lane_direction = 20.0
    ...
    def process(self, origin_img):
        ...
        # if abs(curvature_angle) >= 6:
        #     pass
        # elif 4 <= abs(curvature_angle) < 6 and 20 <= abs(base_diff) < 30:
        ...
        # elif abs(curvature_angle) < 4 and abs(base_diff) < 20:
        #     if curvature_angle_new > 0:
        ...
        #     else:
        #         curvature_angle_new = 0
        if right_lane_detected is True:
            if abs(base_diff) > 30:
                pass
            elif 20 < abs(base_diff) <= 30:
                if curvature_angle_new > 0:
                ...
                if curvature_angle_new > 0:
                    ...
                    curvature_angle_new = -3
            elif 0 < abs(base_diff) <= 10:
                if curvature_angle_new > 0:
                    curvature_angle_new = 2
                elif curvature_angle_new < 0:
                    curvature_angle_new = -2
            elif abs(base_diff) == 0:
                curvature_angle_new = 0
        elif  right_lane_detected is False:
            curvature_angle_new = 12
        ...
        combined_img = cv2.line(combined_img,(330, 350), (330, 410),(255,255,0),1)
